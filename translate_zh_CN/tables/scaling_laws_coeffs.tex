\begin{table}[h!]
    ...
    \begin{minipage}[b]{1\linewidth}
        ...
        \begin{tabular}{lccccccccc}
            ...
            \shline
            GPT3 \citep{brown2020language} & Text &  -- & -- & -- & -- & -- & -0.048 & \\
            Chinchilla \citep{hoffmann2022training} & Text &  1.693 & 0.339 & 0.285 & 0.46 & 0.54 & -- & \\
            \midrule
            \multirow{4}{*}{NMM (early-fusion)} & Text &  2.222 & 0.308 & 0.338 & 0.525 & 0.477     & -0.042 & 0.909 \\
            ...
            \midrule
            \edit{Sparse NMM (early-fusion)} & AVG & 2.158  & 0.710 & 0.372 & 0.361  & 0.656 & -0.047 & 1.797 \\
        \end{tabular}%
        } \caption{\textbf{原生多模态模型的缩放规律}。我们报告了早期融合和晚期融合模型的缩放规律结果。我们为不同的目标数据类型及其平均损失（AVG）拟合了缩放规律。
        }
